...
Config.RoundTime        = CreateConVar("hs_roundtime", "10", convarFlags) -- Time for the seekers to find the hiders
Config.PreGameTime      = CreateConVar("hs_pregametime", "10", convarFlags) -- Time to wait after the map changes until starting the game
Config.HidingTime       = CreateConVar("hs_hidingtime", "15", convarFlags) -- Time at the start of the round that seekers are blinded
